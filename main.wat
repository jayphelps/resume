(module
  ...
  (global $jobTitle1 i32 (i32.const 559))
  (global $jobDate1 i32 (i32.const 584))
  ...
  (data (i32.const 559) "Chief Software Architect\00")
  (data (i32.const 584) "June 2017 (part-time) - Feb 2018 (full-time) - Present\00")
