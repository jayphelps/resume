(module
  ...
  (data (i32.const 639) "Led the architecture of client projects in various languages and domains. Helped with Developer Relations and strategy for clients. Mentoring for engineers of clients, employees, and subcontractors.      \00")
  ...
  (data (i32.const 1426) "Led the development of our e-signing web app in JavaScript. Created PDF manipulation utilities (written in C++) that solved performance issues with our previous PHP-based solutions. Also created Objective-C++ bindings for it that were utilized in our iOS app for offline capability. \00")
